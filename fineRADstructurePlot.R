...
chunkfile<-"glabra_UIC_1000min.alleles.min4_chunks.out" ## RADpainter output file
mcmcfile<-"glabra_UIC_1000min.alleles.mcmc.xml" ## finestructure mcmc file
treefile<-"glabra_UIC_1000min.alleles.mcmcTree.xml" ## finestructure tree file
...
analysisName <- "glabra_UIC_1000min";  maxIndv <- 10000; maxPop<-10000
