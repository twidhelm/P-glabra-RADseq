...
chunkfile<-"glabra_UIC_1000min-noOG_50.alleles.min109_chunks.out" ## RADpainter output file
mcmcfile<-"glabra_UIC_1000min_50.alleles.mcmc.xml" ## finestructure mcmc file
treefile<-"glabra_UIC_1000min_50.alleles.mcmcTree.xml" ## finestructure tree file
...
analysisName <- "glabra_UIC_1000min_50";  maxIndv <- 10000; maxPop<-10000
